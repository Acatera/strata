...
nasm -f win64 -g %1 -o obj/%filename%.o
...
ld -e _start obj/%filename%.o -o bin/%filename%.exe -lkernel32 -lWs2_32 -Llib
...
echo Executable is located at !ESC![32mbin/%filename%.exe!ESC![0m
