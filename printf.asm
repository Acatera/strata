...
section .data
    name db "John", 0
    format db "Hello %x %d %d %d %d %d %s %p %% %u", 0xd, 0xa, 0
    format3 db "Hello %x", 0xd, 0xa, 0
...
.then_decimal_specifier:
    ...
    itoa([rbp + 0x20 + r14 * 8], myprintfBuffer)
...
.then_unsigned_specifier:
    multipush rsi, rax
    ; convert number to string
    itoad([rbp + 0x20 + r14 * 8], myprintfBuffer)
    mov rsi, myprintfBuffer
    mov rcx, rax     ; char count of number
    rep movsb        ; copy number to buffer
    mov rcx, rax     ; char count of number
...
.then_hexadecimal_specifier:
    ...
    ; convert number to string
    itoah([rbp + 0x20 + r14 * 8], myprintfBuffer)
    mov rsi, myprintfBuffer
    mov rcx, rax     ; char count of number
    rep movsb        ; copy number to buffer
    mov rcx, rax     ; char count of number
